...
export default function Post() {
    return (
        <>
            ...
            <X.P>（整体的思想就是，找到一个最容易猜出，也就是猜测次数最少的模式，用这个模式所需的猜测次数来代表密码强度。）</X.P>
            <X.H2>局限</X.H2>
            ...
            <X.HighlightBlock>
                <X.P>看到各图中都有很多水平的“条带”，一般来说LUDS方法对具体字符是不敏感的，比如`hello`、`abcde`、`vdskj`很可能具有相同的分数，此时大量的密码都对应了同一个估计分数，但是PGS指标可能相差较多，就形成了一条水平线；</X.P>
