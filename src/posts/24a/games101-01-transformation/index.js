    ...
    return (
        <>
            ...
            <X.Formula
                ...
                "
            />
            <X.Image src="fig3.jpg" width="600px" themeAdaptive />
            <X.H2>平移 Translation - 引入齐次坐标</X.H2>
            <X.P>下面这个简单的平面平移变换并不能用`2`维矩阵表示：</X.P>
            <X.Image src="fig4.jpg" width="600px" themeAdaptive />
            <X.HighlightBlock>
                <X.H3>引入齐次坐标</X.H3>
            ...
            <X.H2>视图变换</X.H2>
            <X.P>
                确定一个相机需要三个向量：\n相机位置{`$\\bm{e}$`}、观测方向{`$\\bm{g}$`}（相机对着哪儿拍？）、向上方向
                {`$\\bm{t}$`}（横着，竖着，还是斜着拍？）
            </X.P>
            <X.P>
            ...
            <X.Image src="fig6.jpg" width="500px" themeAdaptive />
            <X.Formula
                text="
