...
export default function Post() {
    return (
        <>
            ...
            <X.Image src="fig1.png" width="500px" themeAdaptive />
            ...
            <X.FlexRow minWidth="600px">
                <X.Image src="fig2.png" width="33%" themeAdaptive />
                <X.Image src="fig3.png" width="33%" themeAdaptive />
                <X.Image src="fig4.png" width="33%" themeAdaptive />
            </X.FlexRow>
            <X.P>决策线垂直于样本中心的连线并且在先验概率相等的前提下过样本中心连线中点`(左图)`。\n如果先验概率不相等，决策线会偏向先验概率小的一侧`(中图)`，而且有可能超过端点`(右图)`。</X.P>
            <X.P>对于三分类问题，得到的结果类似：</X.P>
            <X.Image src="fig5.png" width="500px" themeAdaptive />
            <X.Oli>
            ...
            <X.Image src="fig7.png" width="500px" themeAdaptive />
            <X.Oli>
            ...
            <X.FlexRow minWidth="600px">
                <X.Image src="fig8.png" width="33%" themeAdaptive />
                <X.Image src="fig9.png" width="33%" themeAdaptive />
                <X.Image src="fig10.png" width="33%" themeAdaptive />
            </X.FlexRow>
        </>
    );
}
