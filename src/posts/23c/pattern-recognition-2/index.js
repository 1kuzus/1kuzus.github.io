        ...
        <>
            ...
            <X.HighlightBlock background="gray">
                <X.P>
                    ...
                    描述，即$x_i=1$的概率为$\theta_i$，相应地，$x_i=0$的概率为$1-\theta_i$。假设现在已经观察到样本
            ...
            <X.Formula text="P(\bm{X}_1, \bm{X}_2, \dots, \bm{X}_n|\bm{\theta}) = \prod_{k=1}^n P(\bm{X}_k) = \prod_{k=1}^n \prod_{i=1}^d \theta_i^{x_{ki}}(1-\theta_i)^{1-x_{ki}}" />
            ...
            <X.P>
                ...
                \n其含义为，对于第一个维度，四个样本均为`1`，因此估计$x_1=1$的概率为`1`；对于第二个维度，四个样本中有两个为`1`，另外两个为`0`，则估计$x_2=1$的概率为`0.5`，以此类推。
            </X.P>
            ...
            <X.HighlightBlock background="gray">
                ...
                <X.P>
                    ...
                    ，其中$x_1=1.3$，$x_2=4.1$，$x_3=3.7$，已知正态分布的标准差$\sigma=3$，现在只需要估计均值$\mu$。
                </X.P>
                <X.Uli>
                    <X.P>
            ...
            />
            <X.H3>贝叶斯学习程序实现</X.H3>
            <X.P>假设我们有一个标准差$s=3$的正态分布样本集，均值$m$待估计。</X.P>
            <X.CodeBlock
                language="python"
                code={`
            ...
            />
            <X.P>观察迭代结果：</X.P>
            <X.Image src="fig1.png" width="100%" themeAdaptive />
