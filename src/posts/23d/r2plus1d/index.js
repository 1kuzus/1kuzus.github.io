    ...
    return (
        <>
            <X.P>
                ...
                Recognition[https://arxiv.org/pdf/1711.11248.pdf]@讨论了几种用于行为识别的时空卷积网络。文中提出了R(2+1)D网络，即将R3D网络中的3D卷积拆分成2D空间卷积+1D时间卷积。
            </X.P>
            <X.P>
            ...
            <X.Image src="fig1.jpg" width="100%" filterDarkTheme />
            ...
            <X.Image src="fig2.jpg" width="600" filterDarkTheme />
        </>
    );
}
