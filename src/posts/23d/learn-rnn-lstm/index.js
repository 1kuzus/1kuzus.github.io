...
export default function Post() {
    return (
        <>
            ...
            <X.Image src="fig1.png" width="600px" themeAdaptive />
            <X.P>现在明确一下我们的方案：</X.P>
            ...
            <X.Image src="lstm3.png" width="600px" themeAdaptive />
            <X.HighlightBlock background="gray">
                <X.P>举一个概念性的例子：</X.P>
            ...
            <X.Image src="lstm4.png" width="600px" themeAdaptive />
            <X.P>经历这两步之后，便可以相加得到新的单元状态：</X.P>
            <X.Image src="lstm5.png" width="600px" themeAdaptive />
            <X.HighlightBlock background="gray">
            ...
            <X.Image src="lstm6.png" width="600px" themeAdaptive />
            <X.HighlightBlock background="gray">
