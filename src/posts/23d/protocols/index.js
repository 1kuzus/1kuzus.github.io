...
export default function Post() {
    return (
        <>
            ...
            <X.Image src="sw.png" width="100%" themeAdaptive />
            ...
            <X.H3>累计确认</X.H3>
            <X.Image src="gbn1.png" width="100%" themeAdaptive />
            ...
            <X.H3>有差错情况</X.H3>
            <X.Image src="gbn2.png" width="100%" themeAdaptive />
            ...
            <X.H3>争用期</X.H3>
            <X.Image src="csma1.png" width="100%" themeAdaptive />
            ...
            <X.Image src="csma2.png" width="600" themeAdaptive />
            ...
            <X.P>如果一个帧的长度过大，一个站点不停地发送帧，其他站点就一直无法使用信道；如果帧的长度过大，接收方的缓冲区也可能产生溢出。以太网规定数据部分最长为`1500`字节，加上帧头和帧尾，帧的最大长度为`1518`字节。</X.P>
            <X.H2>碰撞避免 - CSMA/CA</X.H2>
            <X.P>在无线局域网中可能会出现隐蔽站的问题，使用碰撞检测意义不大。不同于以太网，802.11标准使用*碰撞避免*`(Collision Avoidance, CA)`而不是碰撞检测。</X.P>
            <X.Image src="csma3.png" width="600" themeAdaptive />
            <X.H3>使用确认帧</X.H3>
            ...
            <X.Image src="ospf.png" width="600" themeAdaptive />
            <X.H3>OSPF 相较于 RIP 的优点</X.H3>
            <X.Uli>安全：使用鉴别，仅有受信任的路由器能参与OSPF协议，可防止恶意入侵者将不正确的信息注入路由器表内。</X.Uli>
            ...
            <X.FlexRow minWidth="600px">
                <X.Image src="bgp1.png" width="50%" themeAdaptive />
                <X.Image src="bgp2.png" width="50%" themeAdaptive />
            </X.FlexRow>
            <X.P>在不同自治系统内，度量路由的代价可能不同；自治系统之间的路由选择也需要考虑相关的政治、经济、安全因素。BGP只希望选择一条可达，无环路，且相对较优的路由。</X.P>
            <X.Image src="bgp3.png" width="600px" themeAdaptive />
            ...
            <X.Uli>可以用`::`表示一组或多组连续的`0`，但*只能出现一次*。</X.Uli>
            ...
            <X.Image src="ip.png" width="100%" themeAdaptive />
            <X.Uli>扩大了地址空间，从`32`位变为`128`位</X.Uli>
            ...
            <X.Image src="tcpudp.jpg" width="600" themeAdaptive />
            ...
            <X.Image src="tcp1.jpg" width="100%" themeAdaptive />
            <X.H3>TCP连接释放</X.H3>
            ...
            <X.Image src="tcp2.jpg" width="100%" themeAdaptive />
            <X.H3>TCP可靠传输</X.H3>
            ...
            <X.HighlightBlock background="gray">
                <X.H3>拥塞控制的实现</X.H3>
                <X.Image src="tcp3.jpg" width="600" themeAdaptive />
                <X.H3>慢开始</X.H3>
