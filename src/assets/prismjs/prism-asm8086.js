Prism.languages.asm8086 = {
    ...
    keyword:
        /\b(?:assume|end|db|dw|dd|dq|dt|equ|org|proc|endp|segment|ends|public|extern|global|section|bits|times|resb|resw|resd|resq|byte|word|dword|qword|align)\b/i,
    register: {
