...
export default function Blog({title}) {
    return (
        <X.BlogWrapper>
            ...
            <X.Image src={require('./fig1.png')} width="500px" invertInDarkTheme />
            <X.P>
            ...
            <X.FlexRow>
                <X.Image src={require('./fig2.png')} width="320px" invertInDarkTheme />
                <X.Image src={require('./fig3.png')} width="320px" invertInDarkTheme />
                <X.Image src={require('./fig4.png')} width="320px" invertInDarkTheme />
            </X.FlexRow>
            <X.P>
                决策线垂直于样本中心的连线并且在先验概率相等的前提下过样本中心连线中点`(左图)`。\n如果先验概率不相等，决策线会偏向先验概率小的一侧`(中图)`，而且有可能超过端点`(右图)`。
            </X.P>
            <X.P>对于三分类问题，得到的结果类似：</X.P>
            <X.Image src={require('./fig5.png')} width="500px" invertInDarkTheme />
            <X.Oli>
            ...
            <X.Image src={require('./fig7.png')} width="500px" invertInDarkTheme />
            <X.Oli>
            ...
            <X.FlexRow>
                <X.Image src={require('./fig8.png')} width="320px" invertInDarkTheme />
