...
export default function Blog({blogTitle}) {
    return (
        <X.BlogWrapper>
            ...
            <X.P>
                参考
                @https://github.com/github-linguist/linguist/blob/master/docs/overrides.md#vendored-code[https://github.com/github-linguist/linguist/blob/master/docs/overrides.md#vendored-code]@
            </X.P>
