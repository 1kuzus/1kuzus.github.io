...
export default function Blog() {
    return (
        <X.BlogWrapper>
            ...
            <X.P noMarginBottom>UDP首部由`20`字节固定首部和最大`40`字节的扩展首部构成。下面是对一些字段的解释：</X.P>
            <X.Uli>
                <X.P>
            ...
            <X.HighlightBlock bgcolor="gray">
                ...
                <X.P noMarginBottom>
                    ...
                    随着拥塞窗口增大，可能会有报文段发生丢失，引起发送方重重计时器超时。因此发送方判断网络可能出现了拥塞，此时会：
                </X.P>
                <X.Uli>将慢开始门限值值更新为发生拥塞时拥塞窗口的一半</X.Uli>
                <X.Uli>
