...
const path = '/24c/papers-sec-240728-2fa-consistency/';
...
export default function Post() {
    return (
        <>
            ...
            <X.P>本文工作的关键区别在于，本文不研究形式、内容或功能的具体变化如何影响2FA的易用性和具体体验，而是首次系统地研究现有流行网站用户体验的*一致性*。论文的核心贡献是衡量各个网站的2FA用户旅程服从雅各布定律的程度。</X.P>
