...
const path = '/24b/cross-site-request-forgery/';
    ...
    return (
        <>
            ...
            <X.Oli>
                ...
                <X.CodeBlock language="text" code="http://www.mybank.com/transfer?to=[SomeAccount]&amount=[SomeAmount]" />
            ...
            <X.CodeBlock
                ...
                `}
            />
            <X.P>当用户访问这个页面时，`POST`请求会被触发；如果用户登录了`www.mybank.com`，请求时会自动带上cookie；`www.mybank.com`认为这是用户的请求，因而将其作为正常请求处理。</X.P>
            <X.H1>练习</X.H1>
            <X.P>下文给出的PortSwigger靶场中有关CSRF的Lab目标是构造一个恶意站点，更改访问它的用户的邮箱地址。\n攻击者可以通过账号`wiener:peter`了解网络请求结构。</X.P>
